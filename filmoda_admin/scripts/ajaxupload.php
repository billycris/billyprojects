...
<?php
	if($imgUploaded){
		echo '<img src="/images/success.gif" width="16" height="16" border="0" style="marin-bottom: -4px;" /> Success!';
	}else{
		echo '<img src="/images/error.gif" width="16" height="16px" border="0" style="marin-bottom: -3px;" /> Error uploading!';
